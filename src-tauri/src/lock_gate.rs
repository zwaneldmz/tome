...
pub const CHANNEL_OF_COMMAND: &[(&str, &str)] = &[
    ...
    ("conductor_set_root", "conductor:cwd"),
    ...
    ("graphify_cancel", "graphify:cancel"),
    ("graphify_query", "graphify:query"),
    ("graphify_path", "graphify:path"),
    ("graphify_explain", "graphify:explain"),
    ("graphify_affected", "graphify:affected"),
    ("mentor_answer", "mentor:answer"),
    ("mentor_judge", "mentor:judge"),
    ("review_generate", "review:generate"),
    ("opencode_status", "opencode:status"),
    ("opencode_key_set", "opencode:key-set"),
    ("opencode_models", "opencode:models"),
    ("opencode_set_model", "opencode:set-model"),
];
